...
import com.WarehouseManagement.security.JwtUtils;
import com.WarehouseManagement.service.UserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        user.setPassword(encoder.encode(signUpRequest.
                getPassword()));
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "manager":
                        Role modRole = roleRepository.findByName(RoleEnums.MANAGER)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
                        break;
                    default:
